...
const styles = StyleSheet.create({
  ...
  hubTitle: { fontSize: FontSize.xxxl, fontWeight: '700', color: Colors.text, letterSpacing: -0.5 },
  ...
  hubTabText: { fontSize: FontSize.md, fontWeight: '500', color: Colors.textSecondary },
  ...
  savedCardTitle: { fontSize: FontSize.md, fontWeight: '600', color: Colors.text, marginBottom: 8 },
  ...
  budgetLabel: { fontSize: FontSize.md, fontWeight: '500', color: Colors.text, marginBottom: 12 },
  ...
  budgetInput: { flex: 1, paddingHorizontal: 8, paddingVertical: 14, fontSize: FontSize.lg, fontWeight: '600', color: Colors.text },
  remainingSection: { alignItems: 'center', marginTop: 24 },
  remainingAmount: { fontSize: FontSize.xxxl, fontWeight: '700', color: Colors.text },
  remainingLabel: { fontSize: FontSize.md, color: Colors.textSecondary, marginTop: 4 },
  budgetRow: { marginTop: 20 },
  budgetRowHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  budgetCatName: { fontSize: FontSize.md, fontWeight: '600', color: Colors.text },
  budgetAmountText: { fontSize: FontSize.md, fontWeight: '700', color: Colors.text },
  ...
  notesTitle: { fontSize: FontSize.base, fontWeight: '600', color: Colors.text },
  notesSubtitle: { fontSize: FontSize.md, color: Colors.textSecondary },
  // Invites
  ...
  guestStatBig: { fontSize: 56, fontWeight: '700', color: Colors.text },
  ...
  guestStatMed: { fontSize: FontSize.xxl, fontWeight: '700' },
  ...
  guestName: { fontSize: FontSize.md, fontWeight: '500', color: Colors.text, flex: 1 },
  ...
  addGuestBtnText: { color: '#fff', fontSize: FontSize.md, fontWeight: '500' },
  // Shared
